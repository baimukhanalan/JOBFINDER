...
_NAMES = {
    "United States": (
        # first names — male + female, balanced
        ["James", "Michael", "Daniel", "Ethan", "Noah", "Mason", "Logan", "Jackson", "Aiden",
         ...
         "Reese", "Sienna", "Elena", "Faith", "Harper", "Maya", "Layla", "Alice"],
    ...
    "Canada": (
        ["Liam", "Owen", "Nathan", "Aiden", "William", "Samuel", "Felix", "Thomas", "Gabriel",
         ...
         "Sophie", "Genevieve", "Isabelle", "Florence", "Colette", "Anais"],
    ...
    "Kazakhstan": (
        ...
        ["Serikuly", "Zhaksybek", "Toleubek", "Amirkhan", "Beisenov", "Yesenov", "Nurpeisov",
         ...
         "Turlybek", "Ospanov", "Duisenbek", "Khamitov"]),
}
_GENERIC_NAMES = (
    ["Alex", "Daniel", "Adrian", "Lucas", "David", "Marco", "Victor", "Theo", "Leon", "Felix",
     ...
     "Nadia", "Yara", "Lucia", "Amara", "Freya", "Zara", "Ana", "Elsa", "Marta"],
    ["Novak", "Silva", "Kovac", "Costa", "Popov", "Moreau", "Duarte", "Weiss", "Ferrari",
     ...
     "Oliveira", "Pavlov", "Romano", "Santos", "Tanaka", "Vega", "Wagner"])
_CITIES = {
